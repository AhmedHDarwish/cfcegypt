...
class PersonalSalesTarget(models.Model):
    ...
    def _compute_sale_order_ids(self):
        super(PersonalSalesTarget, self)._compute_sale_order_ids()
    ...
    def _get_sales_invoices(self):
        return self.sale_person_id.st_sales_invoice_ids.filtered(lambda inv: inv.invoice_date >= self.start_date and inv.invoice_date <= self.end_date)
    ...
    def _compute_sales_invoice_ids(self):
        super(PersonalSalesTarget, self)._compute_sales_invoice_ids()
